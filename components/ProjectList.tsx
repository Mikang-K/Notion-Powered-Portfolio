...
export function ProjectList({ projects, isAdmin: _isAdmin }: ProjectListProps) {
  return (
    <section id="projects" data-section="projects" className="py-16 lg:py-24 px-6 lg:px-12">
